"""A hello-world filter plugin in sshedmake_namespace_05.myrhdh_05."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_05 Myrhdh_05
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_05.myrhdh_05.hello_world }}"
"""
